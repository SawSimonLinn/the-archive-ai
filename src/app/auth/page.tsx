...
import { Archive, Eye, EyeOff, Fingerprint, Github } from "lucide-react"
  ...
  return (
    <div className="relative">
      ...
      <Button
        ...
        className="absolute right-0 top-0 h-12 w-12 rounded-none border-2 border-foreground border-l-2 text-foreground hover:border-foreground hover:bg-muted focus-visible:ring-primary focus-visible:ring-offset-0"
      >
        ...
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="login">
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <PasswordInput name="password" className="border-2 border-foreground rounded-none h-12 focus-visible:ring-primary" required />
              </div>
          ...
          <TabsContent value="signup">
            <form onSubmit={handleSignUp} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label className="font-mono text-[10px] uppercase font-bold tracking-widest opacity-60">Password</Label>
                <PasswordInput name="signup-password" className="border-2 border-foreground rounded-none h-12" required />
              </div>
