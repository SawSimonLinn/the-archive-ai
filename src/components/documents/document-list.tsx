  ...
  if (documents.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center border-8 border-dashed border-foreground/10 bg-muted/20">
        ...
        <h3 className="font-headline font-black text-4xl uppercase tracking-tighter">Vault is Empty</h3>
        <p className="text-lg font-bold text-muted-foreground mt-4 uppercase tracking-widest">No data units found in the neural index.</p>
      </div>
    );
  }
      ...
      <Table>
        <TableHeader className="bg-foreground">
          <TableRow className="hover:bg-foreground border-none">
            <TableHead className="h-16 text-background font-black uppercase tracking-[0.2em] text-xs px-8">Data Unit</TableHead>
            <TableHead className="h-16 text-background font-black uppercase tracking-[0.2em] text-xs px-8">Index Status</TableHead>
            <TableHead className="h-16 text-background font-black uppercase tracking-[0.2em] text-xs px-8">Weight</TableHead>
            <TableHead className="h-16 text-background font-black uppercase tracking-[0.2em] text-xs px-8">Timestamp</TableHead>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56 border-4 border-foreground rounded-none shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-0">
                    <DropdownMenuItem className="gap-3 font-black uppercase tracking-tighter text-sm p-4 focus:bg-primary rounded-none border-b-2 border-foreground">
                      <RefreshCw className="h-5 w-5" /> RE-INDEX
                    </DropdownMenuItem>
                    <DropdownMenuItem className="gap-3 font-black uppercase tracking-tighter text-sm p-4 focus:bg-accent focus:text-accent-foreground text-accent rounded-none">
                      <Trash2 className="h-5 w-5" /> PURGE UNIT
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              </TableCell>
